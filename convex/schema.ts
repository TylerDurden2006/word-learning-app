...
const wordFields = {
  ...
  learning_step: v.optional(v.number()),
  last_quality: v.union(v.number(), v.null()),
  last_rating: v.union(v.string(), v.null()),
  last_prompt_type: v.optional(v.union(v.string(), v.null())),
  lapses: v.number(),
  leech_score: v.optional(v.number()),
...
export default defineSchema({
  ...
  reviewEvents: defineTable({
    ...
    rating: v.string(),
    quality: v.number(),
    prompt_type: v.optional(v.string()),
    ...
    progress_state_after: v.optional(v.string()),
